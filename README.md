...
- The host should periodically re-check spawned panes during execution and close any pane that has already completed, so finished panes do not keep CPU, sandbox, or memory resources alive unnecessarily.
